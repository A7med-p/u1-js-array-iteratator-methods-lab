...
let veryOldInventors = inventors.filter((inv)=>{
    return (1500<inv.year && inv.year<1599)
});
...
let inventorNamedAda = inventors.find((fname)=>{
...
let isAdultPresent = devs.some((above)=>{
    return above.year === '2007' || above.year< '2007';
});
...
let idx = comments.findIndex((idindex)=>{
